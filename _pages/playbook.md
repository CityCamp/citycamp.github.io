...
layout: default
title: Playbook
description: How to organize a CityCamp.
permalink: /playbook/
---
...
If you would like to organize a CityCamp where you live, first check the [CityCamp website](http://citycamp.com) to see if there’s not already an established one for your city.
...
If you have more questions, [post a new issue ticket here](https://github.com/CityCamp/help/issues).
...
[CityCamp](http://http//citycamp.com) is a global effort that brings together local residents to build stronger communities where they live. CityCamp is an unconference focused on innovation for municipal governments and community organizations. CityCamp aims to:
